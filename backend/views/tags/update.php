								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/tags/update.html?id=<?php echo $model['id']; ?>" method="post" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="name" value="<?php echo $model['name'];?>" placeholder="标签" class="m-wrap large" />
