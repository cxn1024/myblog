								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/articles/update.html?id=<?php echo $model['id'];?>" method="post" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="title" value="<?php echo $model['title'];?>" placeholder="标题" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<select class="medium m-wrap" tabindex="1" name="category_id">
															...
															<option value="1" <?php if($model['category_id'] == '1'): ?> selected="selected" <?php endif; ?>>php</option>
